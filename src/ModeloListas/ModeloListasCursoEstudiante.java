 ...
 * @author LightDemon12
 */
public class ModeloListasCursoEstudiante extends AbstractListModel<String> {
...
public String getElementAt(int index){
    ...
    String nombreCursoCI = curso.getNombreC() + "-" +curso.getCodigoC()+ ""; 
    return nombreCursoCI;
}

public Cursos buscarCursosPorNombreEstudiante (String nombreCurso){
